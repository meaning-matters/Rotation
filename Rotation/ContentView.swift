        ...
        ZStack
        {
            ...
            { geometry in
                ZStack
                {
                    ...
                    GeometryReader
                    { geometry in
                        Text(String(format: "%.0f", (self.endAngle - self.startAngle) / 360.0 / self.sensitivity * 100.0))
                            .foregroundColor(.white)
                            .font(.system(size: 100 * (geometry.size.width / 350)))
                ...
                .frame(width: min(geometry.size.width, geometry.size.height * 0.75), height: geometry.size.height, alignment: .center)
